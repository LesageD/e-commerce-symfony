...
class __TwigTemplate_12b072db379728c2572d0129613d67cdb1d80caef13747e85e800aba2e3f4520 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t<h1>";
        // line 8
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["product"]) || array_key_exists("product", $context) ? $context["product"] : (function () { throw new RuntimeError('Variable "product" does not exist.', 8, $this->source); })()), "title", [], "any", false, false, false, 8), "html", null, true);
        echo "</h1>
\t</div>
...
\t\t\t\t<div class=\"d-flex\">
\t\t\t\t\t<img class=\"img-fluid rounded col-6\" src=\"";
        // line 15
...
\t\t\t\t\t\t\t\t";
        // line 19
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["product"]) || array_key_exists("product", $context) ? $context["product"] : (function () { throw new RuntimeError('Variable "product" does not exist.', 19, $this->source); })()), "price", [], "any", false, false, false, 19), "html", null, true);
        echo "
\t\t\t\t\t\t\t\t€
\t\t\t\t\t\t\t</h2>
\t\t\t\t\t\t\t<hr>
...
\t\t\t\t<a href=\"";
        // line 28
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("cart_add", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["product"]) || array_key_exists("product", $context) ? $context["product"] : (function () { throw new RuntimeError('Variable "product" does not exist.', 28, $this->source); })()), "id", [], "any", false, false, false, 28)]), "html", null, true);
...
";
    ...
    {
        return array (  126 => 28,  118 => 23,  111 => 19,  102 => 15,  92 => 8,  89 => 7,  79 => 6,  59 => 3,  36 => 1,);
    }
...
\t\t\t<div class=\"border border-dark rounded p-2 clearfix\">
\t\t\t\t<div class=\"d-flex\">
\t\t\t\t\t<img class=\"img-fluid rounded col-6\" src=\"{{ product.image }}\" alt=\"Image de {{ product.title }}\">
\t\t\t\t\t<div class=\"row\">
\t\t\t\t\t\t<div class=\"col-12\">
\t\t\t\t\t\t\t<h2 class=\"text-right\">
\t\t\t\t\t\t\t\t{{ product.price }}
...
\t</div>
{% endblock %}
", "product/view.html.twig", "/var/www/html/e-commerce-symfony/templates/product/view.html.twig");
    }
}
